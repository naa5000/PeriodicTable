...
var elements = [
	...
	new Element(110,'Darmstadtium',	'Ds',	269),
	new Element(111,'Roentgenium',	'Rg',	272),
	new Element(112,'Copernicium',	'Cn',	277),
	new Element(113,'Ununtrium',	'Uut',	'unknown'),
	new Element(114,'Flerovium',	'Fl',	289),
	new Element(115,'Ununpentium',	'Uup',	'unknown'),
	new Element(116,'Livermorium',	'Lv',	298),
	new Element(117,'Ununseptium',	'Uus',	'unknown'),
	new Element(118,'Ununoctium',	'Uuo',	'unknown')
]; 
